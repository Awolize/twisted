...
class ChampionApi extends base_api_lol_1.BaseApiLol {
	...
	masteryByPUUID(encryptedPUUID, region) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			return this.request(
				region,
				endpoints_1.endpointsV4.ChampionMasteryByPUUID,
				params,
			);
		});
	}
	...
	masteryByPUUIDChampion(encryptedPUUID, championId, region) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			return this.request(
				region,
				endpoints_1.endpointsV4.ChampionMasteryByPUUIDChampion,
				params,
			);
		});
	}
	...
	championsScore(encryptedPUUID, region) {
		return __awaiter(this, void 0, void 0, function* () {
			...
			let { response: score } = yield this.request(
				region,
				endpoints_1.endpointsV4.ChampionsScore,
				params,
			);
