...
describe("Regions", () => {
	describe("regionToRegionGroup", () => {
		it("should match americas", () => {
			expect(regionToRegionGroup(Regions.AMERICA_NORTH)).toEqual(
				RegionGroups.AMERICAS,
			);
			expect(regionToRegionGroup(Regions.BRAZIL)).toEqual(
				RegionGroups.AMERICAS,
			);
			expect(regionToRegionGroup(Regions.LAT_NORTH)).toEqual(
				RegionGroups.AMERICAS,
			);
			expect(regionToRegionGroup(Regions.LAT_SOUTH)).toEqual(
				RegionGroups.AMERICAS,
			);
		});
